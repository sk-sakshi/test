...
<div class="container">
    <a href="{{url('/formlogout')}}" class="btn btn-success float-right ">Logout</a>
...
<input type="address" class="form-control" name="local" id="address-1" placeholder="Locality/House/Street no." >
</div>
<div class="col-sm-6 form-group">
...
<input type="file" name="image" class="form-control" id="file" placeholder="Upload Image">
</div>
<div class="col-sm-6 form-group">
<label for="file">Upload Document</label>
<input type="file" name="document" class="form-control" id="fileDcmnt" placeholder="Upload Document ">
</div>
<div class="col-sm-12">
...
<button type="submit" class="btn float-right"name="submit">Submit</button>
</div>
